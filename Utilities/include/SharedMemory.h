...
#define MUJOCO_SHARE_MEMORY_NAME "share_memory_for_mujoco"
#define ROBOTARM_SHARE_MEMORY_NAME "share_memory_for_xiaotian_arm"
#define MININEZHA_SHARE_MEMORY_NAME "share_memory_for_mininezha"
